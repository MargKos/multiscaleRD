...
print(deltar1, deltar2, deltar3, 'deltar')
...
# Function to calculate boundary concentration
...
def functionsimulation(ts):
    ...
    for t in range(timesteps):
        ...
        if t%int(timesteps/timesteps_cut)==0 and t!=0:
            ...
            np.save('/home/htc/bzfkostr/SCRATCH/SimulationsMultiscale/SIRSusParticles_B' + str(start) + 'time'
                    +str(k)+'', SusPositionHalfTime[k])
            np.save('/home/htc/bzfkostr/SCRATCH/SimulationsMultiscale/SIRInfParticles_B' + str(start) + 'time'
                    +str(k)+'',
                    InfPositionHalfTime[k])
            np.save('/home/htc/bzfkostr/SCRATCH/SimulationsMultiscale/SIRRecoveryParticles_B' + str(start) +'time'
                    +str(k)+ '',
