...
np.save('./Solutions/SusAverageTauBTest.npy', DiscreteSusAverage)
np.save('./Solutions/InfAverageTauBTest.npy', DiscreteInfAverage)
np.save('./Solutions/RecAverageTauBTest.npy', DiscreteRecAverage)
