...
def functionAverage(): 
    ...
    for s in range(sim):
        ...
        for t in range(timesteps_cut):
            ...
            Prey_s_t=np.load(f'/home/htc/bzfkostr/SCRATCH/SimulationsMultiscale/ExplicitDiffusionParticles_{s}_time{t}.npy', allow_pickle=True)
...
np.save('./Solutions/ExplicitDiffusionAverage.npy', DiscretePreyAverage)
