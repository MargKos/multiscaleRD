...
def functionsimulation(ts):
    ...
    for t in range(timesteps):
        ...
        # Injection
        PreyChildrenInj = concentrationmovement_tauleaping(Boundaryconcentration[:, t], 1,deltat * 0.5, deltar, L, gamma)
        ...
        if t%int((timesteps-1)/timesteps_cut)==0 and t!=0:
            ...
            np.save(f'/home/htc/bzfkostr/SCRATCH/SimulationsMultiscale/TauProliferationParticles_{start}_time{k}.npy', PreyPosition)
...
np.save('/home/htc/bzfkostr/SCRATCH/SimulationsMultiscale/execution_timeTau'+str(start)+'.npy', elapsed_time)