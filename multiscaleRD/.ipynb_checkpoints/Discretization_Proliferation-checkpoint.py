...
def functionAverage(): 
    ...
    for s in range(sim):
        ...
        for t in range(timesteps_cut):
            ...
            Prey_s_t=np.load(f'/home/htc/bzfkostr/SCRATCH/SimulationsMultiscale/ProliferationParticles_{s}_time{t}.npy', allow_pickle=True)
...
np.save('./Solutions/ProliferationAverage.npy', DiscretePreyAverage)
